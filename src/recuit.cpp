...
int main ()
{
	...
	ifstream fichier(s, ios::in); 
		...
		int r=10; //nombre d'itérations par palier de température
		float Tinit=100; //température
		float phi=0.9;//facteur de décroissance
		int Kmax=10;//nombre de paliers de température
/*
